...
#Savedirname
SaveDirName = "SaveFiles/NodeNum_%d_Repeats_%d_Timesteps_%d_MinF_%0.3f_MaxF_%0.3f_FStep_%0.3f_PNumMin_%d_PNum_Max_%d_PNum_Num_%d"%(n,Repeats,T,F_Min,F_Max,F_step,PNum_Min,PNum_Max,PNum_Num)#"SaveFiles/NodeNum_%d_PatchNum_%d_Fitness_%0.3f_Repeats_%d_Timesteps_%d_GeoRad_%0.3f_RandConnectionProb_%0.3f"%(n,PNum,F,Repeats,T,R,p)
