...
if Type == "ER":
    ...
    SaveDirName= ("SaveFiles/ER_minC_%0.3f_maxC_%0.3f_Cnum_%d_NodeNum_%d_ZealotProb_%0.5f_Fitness_%0.3f_Timesteps_%d_SingleActive_%r_Repeats_%d_LargestComponent_%r"%
                (minC,maxC,Cnum,n,P,F,T,SingleActive,Repeats,LargestComponent))
